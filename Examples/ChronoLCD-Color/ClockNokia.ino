...
#define BACKGROUND 0xFFF  // room for growth, adjust the background color according to daylight
#define C_COLOR  0xF00  // This is the color of the clock face, and digital clock
#define H_COLOR  0x00F // hour hand color
#define M_COLOR  0x0F0  // minute hand color
#define S_COLOR  0xFF0  // second hand color
...
void displayDigitalTime(int h, int m, int s, int ap)
{
  ...
  lcd.PutStr(timeChar, CLOCK_CENTER + CLOCK_RADIUS + 4, 22,LARGE, 
              C_COLOR, BACKGROUND);
}
...
void drawClock()
{
  ...
  lcd.PutStr("12", CLOCK_CENTER - CLOCK_RADIUS, 66-9,MEDIUM, C_COLOR, BACKGROUND);
  lcd.PutStr("3", CLOCK_CENTER - 9, 66 + CLOCK_RADIUS - 12, MEDIUM,C_COLOR, BACKGROUND);
  lcd.PutStr("6", CLOCK_CENTER + CLOCK_RADIUS - 18, 66-4, MEDIUM,C_COLOR, BACKGROUND);
  lcd.PutStr("9", CLOCK_CENTER - 9, 66 - CLOCK_RADIUS + 4, MEDIUM,C_COLOR, BACKGROUND);
}
