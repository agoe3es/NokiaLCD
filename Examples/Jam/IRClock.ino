...
void loop()
{
 ...
 printHari();
 suka(76,4);
 lcd.LCDSetRect(76,2,100,130,0,merah);
 lcd.LCDSetRect(75,3,99,129,0,merah);
 lcd.LCDPutStr("LIKE",90,38,besar,merah,putih);
 logo(106,4);
 lcd.LCDSetRect(106,2,130,130,0,merah);
 lcd.LCDSetRect(105,3,129,129,0,merah);
 lcd.LCDPutStr("SUBSCRIBE",116,38,besar,merah,putih);
}