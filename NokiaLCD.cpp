...
/**************************************/
void NokiaLCD::clear(uint16_t color, byte x0, byte y0, byte x1, byte y1)
{
...
//
// PutChar("Hello World!", 20, 20, LARGE, WHITE, BLACK);
//
//
// Author: James P Lynch July 7, 2007
// *************************************************************************************************
void NokiaLCD::PutStr(char *pString, int x, int y, int Size, int fColor, int bColor)
{
...
//
// PutChar('E', 20, 20, MEDIUM, WHITE, BLACK);
//
// (27,20) (27,27)
// | |
// | |
...
// Author: James P Lynch July 7, 2007
// *****************************************************************************
void NokiaLCD::PutChar(char c, int x, int y, int size, int fColor, int bColor) 
{
  int i,j;
  unsigned int  nCols;
  unsigned int  nRows;
...
//
// *************************************************************************************************
void NokiaLCD::SetLine(int x0, int y0, int x1, int y1, int color) 
{
  int dy = y1 - y0;
  int dx = x1 - x0;
  int stepx, stepy;
...
// Author: James P Lynch July 7, 2007
// *****************************************************************************************
void NokiaLCD::SetRect(int x0, int y0, int x1, int y1, unsigned char fill, int color) 
{
...
//
// *************************************************************************************
void NokiaLCD::SetCircle(int x0, int y0, int radius, int color) 
{
  int f = 1 - radius;
  int ddF_x = 0;
  int ddF_y = -2 * radius;
...
// *************************************************************************************
void NokiaLCD::SetPixel(byte x, byte y, int color) 
{
  SetXY(x, y);
  sendCMD(RAMWR);
  // For some reason, it has to send blue first then green and red
...
// Modified: Gravitech December 20, 2008
// *****************************************************************************
void NokiaLCD::SetXY(byte x, byte y) 
{
  // Row address set (command 0x2B)
  sendCMD(PASET);
  sendData(x);
